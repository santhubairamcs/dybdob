...
public class GenerateUnifiedDiffTest extends TestCase {
    ...
    static final String originalFilename = "mocks" + FS + "original.txt";
    static final String revisedFilename = "mocks" + FS + "revised.txt";
    static final String originalFilenameOneDelta = "mocks" + FS + "one_delta_test_original.txt";
    static final String revisedFilenameOneDelta = "mocks" + FS + "one_delta_test_revised.txt";
